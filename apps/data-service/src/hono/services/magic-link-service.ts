...
export async function sendMagicLinkEmail(
	...
	const preheader = isAdminLink
		? "Link do panelu administracyjnego onboardingu Grota."
		: "Link pracownika do autoryzacji Google Drive w Grota.";

	const roleLabel = isAdminLink ? "Administrator klienta" : "Pracownik";
	const validity = "Link jest wazny przez 7 dni od chwili wysylki.";
				...
				<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;background:#0b1226;border:1px solid #1f2a44;border-radius:12px;">
					<tr>
						<td style="padding:24px 24px 12px 24px;">
							...
							<h1 style="margin:0;font-size:22px;line-height:1.3;color:#f9fafb;">${subject}</h1>
						</td>
					</tr>
					<tr>
						<td style="padding:8px 24px 0 24px;">
							<p style="margin:0 0 12px 0;font-size:16px;line-height:1.6;color:#f3f4f6;">Czesc ${name},</p>
							<p style="margin:0 0 12px 0;font-size:15px;line-height:1.6;color:#cbd5e1;">${intro}</p>
							<p style="margin:0 0 18px 0;font-size:14px;line-height:1.6;color:#93c5fd;"><strong>Rola:</strong> ${roleLabel}</p>
						</td>
					</tr>
					<tr>
						<td style="padding:0 24px 8px 24px;">
							<a href="${url}" style="display:inline-block;background:#10b981;color:#052e2b;text-decoration:none;padding:12px 18px;border-radius:8px;font-size:14px;font-weight:700;">
								${cta}
							</a>
						</td>
					</tr>
					<tr>
						<td style="padding:8px 24px 0 24px;">
							<p style="margin:0 0 8px 0;font-size:13px;line-height:1.6;color:#94a3b8;">${validity}</p>
							<p style="margin:0 0 4px 0;font-size:13px;line-height:1.6;color:#94a3b8;">Jesli przycisk nie dziala, skopiuj ten link do przegladarki:</p>
							<p style="margin:0 0 20px 0;word-break:break-all;font-size:13px;line-height:1.6;color:#86efac;">
								<a href="${url}" style="color:#86efac;text-decoration:underline;">${url}</a>
							</p>
						</td>
					</tr>
					<tr>
						<td style="padding:16px 24px 24px 24px;border-top:1px solid #1f2a44;">
							<p style="margin:0;font-size:12px;line-height:1.6;color:#64748b;">
								To automatyczna wiadomosc systemu Grota. Jesli nie oczekiwales tego maila, zignoruj go.
							</p>
						</td>
					</tr>
				</table>
