				...
				<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;">
					...
					<tr>
						<td style="padding:8px 24px 0 24px;">
							...
							<p style="margin:0 0 12px 0;font-size:15px;line-height:1.6;color:#374151;">${intro}</p>
							<p style="margin:0 0 18px 0;font-size:14px;line-height:1.6;color:#4b5563;"><strong>Rola:</strong> ${roleLabel}</p>
						</td>
					</tr>
					<tr>
						<td style="padding:0 24px 8px 24px;">
							<a href="${url}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;padding:12px 18px;border-radius:8px;font-size:14px;font-weight:600;">
								${cta}
							</a>
						</td>
					</tr>
					<tr>
						<td style="padding:8px 24px 0 24px;">
							<p style="margin:0 0 8px 0;font-size:13px;line-height:1.6;color:#6b7280;">${validity}</p>
							<p style="margin:0 0 4px 0;font-size:13px;line-height:1.6;color:#6b7280;">Jesli przycisk nie dziala, skopiuj ten link do przegladarki:</p>
							<p style="margin:0 0 20px 0;word-break:break-all;font-size:13px;line-height:1.6;color:#2563eb;">
